...
public class BallMovementRight : MonoBehaviour
{
    public float speed = 3;
    public static Dictionary<string, List<Transform>> repositoryDictRight = new Dictionary<string, List<Transform>>();
    ...
    void Start()
    {
        ...
        temp.Add(transform);
        repositoryDictRight.Add(transform.tag, temp);
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        BallMovementRight.repositoryDictRight.TryGetValue(collision.transform.tag, out list);

        int elementsInAllListsCount = 0;

        foreach (List<Transform> li in BallMovementRight.repositoryDictRight.Values)
        {
        ...
        //if (!ExistInDict(repositoryDictRight, collision.transform.tag, collision.transform))
        //{
        //    list.Add(collision.transform);
        ...
        BallMovementRight.repositoryDictRight.Remove(collision.transform.tag);
        BallMovementRight.repositoryDictRight.Add(collision.transform.tag, list);
